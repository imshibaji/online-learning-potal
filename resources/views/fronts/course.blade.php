...
<meta name="keywords" content="{{$course->meta_keys}}" />
<meta name="description" content="{{$course->meta_desc}}">

<!-- Open Graph / Facebook -->
<meta property="og:type" content="website">
<meta property="og:url" content="{{ url('/course/'.$course->slag) }}">
<meta property="og:title" content="{{$course->title}}">
<meta property="og:description" content="{{$course->meta_desc}}">

<!-- Twitter -->
<meta property="twitter:card" content="summary_large_image">
<meta property="twitter:url" content="{{ url('/course/'.$course->slag) }}">
<meta property="twitter:title" content="{{$course->title}}">
<meta property="twitter:description" content="{{$course->meta_desc}}">
